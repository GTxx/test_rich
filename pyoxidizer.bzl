...
def make_exe(dist):
    ...
    python_config.run_mode = 'eval:from test_rich.main import print_table; print_table()'
    ...
    # for resource in exe.pip_install(["./dist/test_rich-0.1.0-py3-none-any.whl"]):
    ...
    exe.add_python_resources(exe.pip_install(["./dist/test_rich-0.1.0-py3-none-any.whl"]))
